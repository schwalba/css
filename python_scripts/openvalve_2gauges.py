...
sp2_high_set_1 = display.getWidget("Text_Update_gauge1_sp2_high_set")
...
if (sp1_high_set_1PV.getValue()):
    ...
    ConsoleUtil.writeInfo("-----loc_on_set_1PV-----")
    loc_on = PVUtil.getLong(loc_on_set_1PV)
    ConsoleUtil.writeInfo(str(loc_on)) 
    ConsoleUtil.writeInfo("-----on_set_1PV-----")
    ...
    if ((loc_sp1_high_set_1.getValue()) and (loc_sp1_low_set_1.getValue())):
        ...
        loc_input_sp1_high_low_1.setVisible(True)
        loc_input_sp1_low_low_1.setVisible(True)
    if ((loc_sp2_high_set_1.getValue()) and (loc_sp2_low_set_1.getValue())):   
        label_sp2_high_low_1.setVisible(True)
        label_sp2_low_low_1.setVisible(True)
        loc_input_sp2_high_low_1.setVisible(True)
        loc_input_sp2_low_low_1.setVisible(True)   
...
sp2_high_set_2 = display.getWidget("Text_Update_gauge2_sp2_high_set")
...
if (sp1_high_set_2PV.getValue()):        
    ...
    if ((loc_sp1_high_set_2.getValue()) and (loc_sp1_low_set_2.getValue())): 
        ...
        sp1_low_set_2PV.setValue(PVUtil.getDouble(loc_sp1_low_set_2PV))
    if ((loc_sp2_high_set_2.getValue()) and (loc_sp2_low_set_2.getValue())): 
        loc_input_sp2_high_low_2.setValue(sp2_high_set_orig_2)
        loc_input_sp2_low_low_2.setValue(sp2_low_set_orig_2)
        sp2_high_set_2PV.setValue(PVUtil.getDouble(loc_sp2_high_set_2PV))
        sp2_low_set_2PV.setValue(PVUtil.getDouble(loc_sp2_low_set_2PV))
     
    #on_set_2PV.setValue(PVUtil.getDouble(loc_on_set_2PV)) 
    ConsoleUtil.writeInfo(str(PVUtil.getString(loc_on_set_2PV)))
...
if ((sp1_high_set_1PV.getValue()) or (sp1_high_set_2PV.getValue())):
    ...
    if (sp1_high_set_1PV.getValue()):
        action_gauge1_reset = display.getWidget("action_gauge1_reset")
        action_gauge1_reset.setVisible(True)
    if (sp1_high_set_2PV.getValue()):
        action_gauge2_reset = display.getWidget("action_gauge2_reset")
        action_gauge2_reset.setVisible(True)

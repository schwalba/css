...
sp1_high_set_1 = display.getWidget("Text_Update_gauge_sp1_high_get")
sp1_low_set_1  = display.getWidget("Text_Update_gauge_sp1_low_get")
sp2_high_set_1 = display.getWidget("Text_Update_gauge_sp2_high_get")
sp2_low_set_1  = display.getWidget("Text_Update_gauge_sp2_low_get")
